...
def main():
    ...
    pre_adj = pickle.load(open('../datasets/' + opt.dataset + '/pre_adj.pkl', 'rb'))
    pre_num = pickle.load(open('../datasets/' + opt.dataset + '/pre_num.pkl', 'rb'))

    adj, num = handle_adj(pre_adj, n_node, opt.n_sample_all, pre_num)
