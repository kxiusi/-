...
seq = pickle.load(open('datasets/' + dataset + '/pre_dense_12.txt', 'rb'))
...
pickle.dump(adj, open('datasets/' + dataset + '/pre_adj_dense_12.pkl', 'wb'))
pickle.dump(weight, open('datasets/' + dataset + '/pre_num_dense_12.pkl', 'wb'))
