...
parser.add_argument('--dataset', default='mooc_cube_video', help='dataset name: diginetica/yoochoose1_4/yoochoose1_64/sample')
...
def main():
    ...
    if opt.dataset == 'diginetica':
        ...
        n_node = 681
    elif opt.dataset == 'mooc_cube_video':
        n_node = 17466
    ...
    adj1 = pickle.load(open('../datasets/' + opt.dataset + '/witg_adj_' + str(opt.n_sample_all) + '.pkl', 'rb'))
    num1 = pickle.load(open('../datasets/' + opt.dataset + '/witg_num_' + str(opt.n_sample_all) + '.pkl', 'rb'))
    # adj2 = pickle.load(open('../datasets/' + opt.dataset + '/adj2_' + str(opt.n_sample_all) + '.pkl', 'rb'))
    # num2 = pickle.load(open('../datasets/' + opt.dataset + '/num2_' + str(opt.n_sample_all) + '.pkl', 'rb'))

    adj, num = handle_adj(adj1, n_node, opt.n_sample_all, num1)
    # adj2, num2 = handle_adj(adj2, n_node, opt.n_sample_all, num2)
    # model = trans_to_cuda(CombineGraph(opt, n_node, adj, num, adj2, num2))
    model = trans_to_cuda(CombineGraph(opt, n_node, adj, num))
