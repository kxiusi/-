...
PATH_TO_TRAIN = '/home/jywang/code/GRU4Rec/processed_data/mooc_cube_train_full.txt'
PATH_TO_TEST = '/home/jywang/code/GRU4Rec/processed_data/mooc_cube_test.txt'
...
if __name__ == '__main__':
    ...
    bpr = baselines.BPR(learning_rate=0.01, n_iterations=30)
    bpr.fit(data)
