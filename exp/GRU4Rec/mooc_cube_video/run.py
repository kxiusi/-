...
PATH_TO_TRAIN = '/home/jywang/code/GRU4Rec/processed_data/mooc_cube_video_train_full.txt'
PATH_TO_TEST = '/home/jywang/code/GRU4Rec/processed_data/mooc_cube_video_test.txt'
...
if __name__ == '__main__':
    ...
    bpr = baselines.BPR(learning_rate=0.1,n_iterations=20)
    bpr.fit(data)
