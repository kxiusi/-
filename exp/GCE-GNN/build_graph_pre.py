...
seq = pickle.load(open('datasets/' + dataset + '/prerequisites.txt', 'rb'))
...
pickle.dump(adj, open('datasets/' + dataset + '/pre_adj.pkl', 'wb'))
pickle.dump(weight, open('datasets/' + dataset + '/pre_num.pkl', 'wb'))
